...
class TestGlobals:
    ...
    def test_is_mutation_within_range(self):
        assert globals.is_mutation_within_range([1234], [1233, 1235]) == True

    def test_is_not_within_range(self):
        assert globals.is_mutation_within_range([1236], [1234, 1235]) == False

    def test_is_mutation_within_range_deletion(self):
        assert globals.is_mutation_within_range([1234, 1236], [1233, 1235]) == True

    def test_is_not_within_range_deletion(self):
        assert globals.is_mutation_within_range([1234, 1236], [1237, 1238]) == False

    def test_is_within_two_ranges(self):
        assert globals.is_mutation_within_range([1234, 1236], [[1233, 1235], [1237, 1238]]) == True

    def test_is_not_within_two_ranges(self):
        assert globals.is_mutation_within_range([1234, 1236], [[1232, 1233], [1237, 1238]]) == False