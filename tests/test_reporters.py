...
class TestWriteCoverageReports:
    ...
    def test_reports_na_for_a_region_without_err_coverage(self, mock_config, make_target_coverage, tmp_path):
        ...
        err = ERRCoverage(coords=[(100, 150)], breadth_of_coverage=0.95, average_depth=100.0)
        gene_map = {
    ...
    def test_keeps_err_columns_in_a_fixed_position_when_the_first_row_lacks_err_coverage(self, mock_config, make_target_coverage, tmp_path):
