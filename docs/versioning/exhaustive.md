...
- v2.8.0 - tNGS lineage designation now requires a 70% coverage threshold of all genes; fixes a bug in tNGS analysis where frequency was not being considered properly for quality control when amplicons were split
