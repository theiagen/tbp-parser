...
- **v4.0.0** - ==_breaking change to the command line_==: created subcommand-based interface, removed bundled default input files, and added validation of all input files against the TBProfiler mutation database
