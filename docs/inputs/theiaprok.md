...
!!! info annotate "TheiaProk Version"
    This information only corresponds to the PHB v2.3.0 release. These inputs and outputs may not be applicable to other versions of TheiaProk.
...
| `merlin_magic` | **tbp_parser_coverage_threshold** | Float | The minimum percentage of a region that has depth above the threshold set by `min_depth` (used for a gene/locus to pass QC) | 100 |
