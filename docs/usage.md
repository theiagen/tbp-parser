...
``` bash
docker pull us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.4.4 #(1)!
```
...
``` bash
docker run -it --entrypoint=/bin/bash us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.4.4
