...
``` bash
docker pull us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.11.3 #(1)!
```
...
``` bash
docker run -it --entrypoint=/bin/bash us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.11.3
