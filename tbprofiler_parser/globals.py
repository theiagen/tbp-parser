def __init__():
  ...
  ANTIMICROBIAL_DRUG_NAME_LIST = ["amikacin", "bedaquiline", "capreomycin", 
                                "clofazimine", "ethambutol", "ethionamide", 
                                "isoniazid", "kanamycin", "levofloxacin", 
                                "linezolid", "moxifloxacin", "pyrazinamide", 
  ...
  GENES_FOR_LIMS = ["atpE", "eis", "embA", "embB", "ethA", "fabG1", "gyrA", 
  ...
  """
  global GENE_LIST_OPTION_1
  GENE_LIST_OPTION_1 = ["atpE", "mmpL5", "mmpS5", "pepQ", "rplC", "rrl", "Rv0678"]
