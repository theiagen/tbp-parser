...
Interpretation documents for v1.2.2 and v1.4.4.8 are available in the main directory of this repository; others are available in the `interpretation_docs` directory.
...
```markdown
docker pull us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:1.4.4.11
```
...
```markdown
docker run -it --entrypoint=/bin/bash us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:1.4.4.11
