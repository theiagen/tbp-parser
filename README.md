...
```markdown
docker pull us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:1.3.9
```
...
```markdown
docker run -it --entrypoint=/bin/bash us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:1.3.9
