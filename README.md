...
```markdown
docker pull us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.0.1
```
...
```markdown
docker run -it --entrypoint=/bin/bash us-docker.pkg.dev/general-theiagen/theiagen/tbp-parser:2.0.1
